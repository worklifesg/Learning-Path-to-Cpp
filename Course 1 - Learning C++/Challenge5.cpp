// Using Challenge 4, we will add move counter to see how many moves were done to win the game and write it to output file (name of winner and how many moves it took)
...
{  
  ...
  int chipsInPile = 0;  
  int chipsTaken = 0; 
  int movecounter = 0; // intialize move counter to 0
  char userChoice;
