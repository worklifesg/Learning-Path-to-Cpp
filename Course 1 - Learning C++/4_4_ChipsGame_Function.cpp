...
// Using function in this program
...
string findplayername(string names[], bool playerturn); // function prototype for asking player to use their chips
string findplayername1(string names[], bool playerturn); // function prototype for winning the game
...
{	
	...
	do // loop to play again one
	{
		...
		while(gameover == false)
		{
			...
			{
				gameover  = true;
				cout << findplayername1(playerName,player1turn) << ", Congratulations you won\n";			
			}
			else
			{
...
string findplayername1(string names[], bool playerturn)
{
	if(playerturn==true)
		return names[1];
	else
